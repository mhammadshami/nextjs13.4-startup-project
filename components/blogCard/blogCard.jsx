    ...
    <div className={classes.container}>
      <div className={classes.wrapper}>
        <Link className={classes.imgContainer} href={`/blog/${_id}`}>
          ...
          <Image src="https://images.pexels.com/photos/17243147/pexels-photo-17243147/free-photo-of-nature.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" width="350" height="350" />
        </Link>
